...
def add_diffusiondet_config(cfg):
    ...
    cfg.MODEL.DiffusionDet.NUM_PROPOSALS = 500
    ...
    # TTA.
    # cfg.TEST.AUG.MIN_SIZES = (224,)
    cfg.TEST.AUG.MIN_SIZES = (400, 500, 600, 640, 700, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1800, 800)
